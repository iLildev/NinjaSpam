...
CATEGORIES: dict[str, tuple[str, str, list[tuple[str, str]]]] = {
    ...
    "settings": (
        ...
        [
            ...
            ("/listcmds",                      "List disabled commands in this group"),
    ...
    "advanced": (
        ...
        [
            ...
            ("/chanprotect <on|off>",          "Block channel post forwarding"),
            ("SpamWatch / Anti-Astro / Adaptive CAPTCHA", "Configured via /settings panel"),
    ...
    "games": (
        "🎮", "Games & Economy",
        [
            ("/my_ninja",              "View your ninja stats & career"),
            ("/ninja_profile",         "Alias for /my_ninja"),
            ...
            ("/topusers",              "Game leaderboard for this chat"),
        ],
    ),
    "social": (
        "💬", "Social & Fun",
    ...
    "scheduler": (
        ...
        [
            ...
            ("/delschedule <id>",              "Cancel a scheduled message by ID"),
        ],
    ),
}
